        ...
        <div class="relative">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="simple-search"
                    ...
                    placeholder="Search  Email..." required v-model="searchEmailLike">
            </div>
            <button type="submit"
                ...
                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"
                    v-on:click="viewgivenStudentsLike">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">Studentd Name</th>
                        <th scope="col" class="px-6 py-3">Student Age</th>
                        <th scope="col" class="px-6 py-3">Studentd Address</th>
...
export default {
    ...
    mounted() {
        //this.viewgivenStudents();
    },
    methods: {
        
        viewgivenStudentsLike() {
            return axios
                .get('http://localhost:8080/select/by/email/like/' + this.searchEmailLike, {
                })
                .then(response => {
                    console.log(response.data);
                    return this.viewStudent = response.data;
                });
        }
    }

<template>
  <div
    ...
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
      <router-link to="/add/page" type="button"
        ...
        <svg
          class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-500"
          aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          <path
            d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z" />
        </svg>
        <span
          class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-500">Add</span>
      </router-link>
      <router-link to="/view/page" type="button"
        ...
        <span
          class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-500">View
          All Information</span>
      </router-link>
      <router-link to="/selectName/page" type="button"
        ...
        <span
          class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-500">Select
          By Name</span>
      </router-link>
      <router-link to="/selectEmail/page" type="button"
